...
// Simple Image replacement for standard React
...
const AnimatedForm = memo(function AnimatedForm({
  ...
  return (
    <section className='max-md:w-full flex flex-col gap-4 w-96 mx-auto'>
      ...
      {/* Google Login Removed for simplicity as per requirement, or keep if needed */}
        ...
        {textVariantButton && goTo && (
          <BoxReveal boxColor='var(--skeleton)' duration={0.3}>
            <section className='mt-4 text-center hover:cursor-pointer'>
              <button
                type="button"
                className='text-sm text-indigo-400 hover:text-indigo-300 hover:cursor-pointer outline-hidden transition-colors'
                onClick={goTo}
              >
                {textVariantButton}
              </button>
